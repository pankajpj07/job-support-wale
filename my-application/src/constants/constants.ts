...
export const missionPoints = [
  'The mission of our IT on-the-job support is to provide the ability to solve complex project requirements in Real-Time for beginners in IT.',
  'Our team at IndiaJobSupport provides job support, training, and consulting for more than 50+ IT courses.',
...
export const whyChooseUsList = [
  'We carefully review your project and the technologies used. If we are 100% confident in our ability to support you, we agree to provide our assistance.',
  'We offer support on a monthly or half-month basis, depending on your needs and project requirements.',
  'Our support team is available for 2 hours every day from Monday to Friday, based on Indian time.',
  'While we typically do not work on weekends, if you are buried under work and have a project deadline approaching, we make exceptions and provide support on weekends as well.',
]
